...
$( options[1]).insertAfter($(options[18]));
    ...
    $(document).ready(function() {
        ...
        //job widget
        (function() {
            $("#myJobsList-1 ul").each(function() {
                var dataURL = $(this).attr("data-url");
                $(this).includeFeed({
                    baseSettings: {
                        rssURL: [dataURL || "/job/rss.aspx?addlocation=1&addworktype=1&addsalary=1"],
                        addNBSP: false,
                        limit: 2
                    },
                    templates: {
        ...
        var baseUrl = "https://www.finite.com.au/blog/";
  ...
  $(".banner-logo .logo").removeClass("active");
        ...
        if ($("#jobsearch-top").length > 0) {
            $('.content-holder').prepend("<h1 class='job-head'>Latest Jobs</h1>");
            $(".content-holder").prepend("<a href='/advancedsearch.aspx?search=1' class='saved-job-list'>My Saved Jobs</a> ");
        }
